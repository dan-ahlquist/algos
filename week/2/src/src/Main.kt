...
/*
    ...
    [TIP: before submitting, first test the correctness of your program on some small
     test files or your own devising. Then post your best test cases to the
...
//    val data = readInputFile()
    ...
    val subject = InversionCounter(data)
    val inversions = subject.inversions
...
fun readInputFile(): List<Int> {
    return File("IntegerArray.txt").useLines { lines ->
